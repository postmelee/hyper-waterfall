...
- [ ] `git diff --check`
- [ ] `grep -RnE '\{[A-Z_]+\}' AGENTS.md CLAUDE.md` 결과에 치환 대상 placeholder 없음
...
표시는 raw URL 대신 `[파일명](https://github.com/postmelee/hyper-waterfall/blob/{head_sha}/mydocs/...)` 형식으로 적습니다.
...
- 단계 보고서: [task_m{milestone}_{issue}_stage1.md](https://github.com/postmelee/hyper-waterfall/blob/{head_sha}/mydocs/working/task_m{milestone}_{issue}_stage1.md)
