...
Migration guide는 README의 짧은 사용자 안내와 `docs/agent-entrypoint.md`의 판단 결과 형식 사이를 잇는 상세 근거 문서다. Hyper-Waterfall 버전 업데이트 PR 워크플로우와 향후 CLI는 README 문구가 아니라 migration guide와 manifest, version 기록을 기준으로 동작해야 한다.
