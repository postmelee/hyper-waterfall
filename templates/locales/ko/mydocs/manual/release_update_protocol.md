...
- 대상 저장소의 사용자 수정 diff
- manifest가 `localization`을 제공하면 현재 locale 기록, 목표 release locale 지원, locale manifest diff, locale 보존/전환 판단
...
- 입력: 기존 업데이트 판단 결과, manifest diff, locale manifest diff, migration guide
