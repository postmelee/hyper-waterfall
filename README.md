...
**(2) 운영 규칙·SKILL·매뉴얼 분리**: `AGENTS.md`에는 매 턴 시스템 프롬프트로 적재될 정책·제약·인덱스만 두고, 절차 상세는 [`mydocs/manual/`](templates/mydocs/manual/)의 5개 매뉴얼(문서 구조, 타스크 진행, Git, PR, 충돌 규칙)과 [`mydocs/skills/`](templates/mydocs/skills/)의 7개 SKILL로 분리했습니다.
